...
function setup() {
  ...
  speed2=random(300,600);
  weight2=random(50,72);
...
function draw() {
  ...
  if(hasCollided(bullet,wall,bullet2,wall2)){
  bullet.velocityX=0;
  bullet2.velocityX=0;
...
function hasCollided(lbullet,lwall,lbullet2,lwall2){
...
if(bulletRightEdge>=wallLeftEdge || bullet2RightEdge>=wall2LeftEdge){
